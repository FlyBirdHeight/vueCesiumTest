...
<el-form ref="billboard" size="mini" :model="billboard" :label-position="'top'">
    <el-form-item label="上传图片">
        <el-upload class="avatar-uploader" action="/api/v1/upload/image" :show-file-list="false" name="image" accept="image/png, image/jpg, image/jpeg" :on-success="handleSuccess">
    ...
    <el-form-item label="缩放比例">
        <el-input-number v-model="billboard.scale" :precision="1" controls-position="right" :step="0.5" :min="0.5" :max="2.0" step-strictly></el-input-number>
    </el-form-item>
